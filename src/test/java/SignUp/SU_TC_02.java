...
public class SU_TC_02 {
    ...
    public void verifyErrorOnEmptyFormSubmission() throws InterruptedException{
        ...
        usernameField.clear();
        passwordField.clear();
        usernameField.sendKeys("usr");  // Username < 4 characters
        ...
        Assert.assertTrue(alertText.contains("too short"), "Username should be at least 4 characters long.");
        Thread.sleep(1000);
