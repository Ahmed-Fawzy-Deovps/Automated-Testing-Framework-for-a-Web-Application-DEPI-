...
public class SU_TC_07 {
    ...
    public void verifyErrorOnEmptyFormSubmission() throws InterruptedException{
        ...
        Assert.assertTrue(alertText.contains("Sign up successful."), "The system should display \"Registration successful!\" and redirect to the login page.");
        Thread.sleep(1000);
